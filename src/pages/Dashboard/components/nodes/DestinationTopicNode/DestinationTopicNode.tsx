...
interface DestinationTopicNodeProps {
  data: TopicNodeData;
  id: string;
}

export const DestinationTopicNode = ({ data, id }: DestinationTopicNodeProps) => {
  ...
  return (
    <motion.div
      key={id}
      className="border-purple pointer-events-all relative max-w-[180px] min-w-[180px] cursor-pointer overflow-hidden border-l-2 px-4 py-2 shadow-xl"
    ...
    >
      ...
      <motion.div
        className="via-purple/20 absolute inset-0 bg-gradient-to-r from-transparent to-transparent"
        animate={{
          x: ['-100%', '200%'],
        }}
        transition={{
